...
export const addClientSlice = createSlice({
    ...
    reducers: {
        ...
        setDateFilter1: (state, action: PayloadAction<string>) => {
            state.first_date = action.payload
        },
        setDateFilter2: (state, action: PayloadAction<string>) => {
            state.second_date = action.payload
        }
    },
